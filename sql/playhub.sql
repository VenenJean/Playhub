...
--
CREATE TABLE
  `permissions` (`ID` int (11) NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
--
ALTER TABLE `bankaccounts` ADD PRIMARY KEY (`IBAN`);
...
--
ALTER TABLE `gamecategory` ADD PRIMARY KEY (`ID`),
ADD KEY `GameId` (`GameId`),
...
--
ALTER TABLE `rolepermission` ADD PRIMARY KEY (`ID`),
...
--
ALTER TABLE `transactionhistory` ADD PRIMARY KEY (`ID`),
ADD KEY `UserId` (`UserId`),
ADD KEY `GameId` (`GameId`);
...
--
ALTER TABLE `userbibliothek` ADD PRIMARY KEY (`ID`),
ADD KEY `UserId` (`UserId`),
ADD KEY `GameId` (`GameId`);
...
--
ALTER TABLE `usercommentreview` ADD PRIMARY KEY (`ID`),
...
--
ALTER TABLE `gamecategory` MODIFY `ID` int (11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `rolepermission` MODIFY `ID` int (11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `transactionhistory` MODIFY `ID` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `userbibliothek`
--
ALTER TABLE `userbibliothek` MODIFY `ID` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `usercommentreview`
--
ALTER TABLE `usercommentreview` MODIFY `ID` int (11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `userrole`
--
ALTER TABLE `userrole` MODIFY `ID` int (11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `comments` ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `users` (`ID`),
ADD CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`GameId`) REFERENCES `games` (`ID`);

--
-- Constraints der Tabelle `gamecategory`
--
ALTER TABLE `gamecategory` ADD CONSTRAINT `gamecategory_ibfk_1` FOREIGN KEY (`GameId`) REFERENCES `games` (`ID`),
ADD CONSTRAINT `gamecategory_ibfk_2` FOREIGN KEY (`CategoryId`) REFERENCES `categories` (`ID`);

--
-- Constraints der Tabelle `games`
--
ALTER TABLE `games` ADD CONSTRAINT `games_ibfk_1` FOREIGN KEY (`PublisherId`) REFERENCES `users` (`ID`);

--
-- Constraints der Tabelle `rolepermission`
--
ALTER TABLE `rolepermission` ADD CONSTRAINT `rolepermission_ibfk_1` FOREIGN KEY (`RoleId`) REFERENCES `roles` (`ID`),
...
--
ALTER TABLE `transactionhistory` ADD CONSTRAINT `transactionhistory_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `users` (`ID`),
ADD CONSTRAINT `transactionhistory_ibfk_2` FOREIGN KEY (`GameId`) REFERENCES `games` (`ID`);

--
-- Constraints der Tabelle `userbibliothek`
--
ALTER TABLE `userbibliothek` ADD CONSTRAINT `userbibliothek_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `users` (`ID`),
ADD CONSTRAINT `userbibliothek_ibfk_2` FOREIGN KEY (`GameId`) REFERENCES `games` (`ID`);

--
-- Constraints der Tabelle `usercommentreview`
--
ALTER TABLE `usercommentreview` ADD CONSTRAINT `usercommentreview_ibfk_1` FOREIGN KEY (`CommentId`) REFERENCES `comments` (`ID`),
ADD CONSTRAINT `usercommentreview_ibfk_2` FOREIGN KEY (`UserId`) REFERENCES `users` (`ID`);

--
-- Constraints der Tabelle `userrole`
--
ALTER TABLE `userrole` ADD CONSTRAINT `userrole_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `users` (`ID`),
ADD CONSTRAINT `userrole_ibfk_2` FOREIGN KEY (`RoleId`) REFERENCES `roles` (`ID`);

--
-- Constraints der Tabelle `users`
--
ALTER TABLE `users` ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`BankAccountId`) REFERENCES `bankaccounts` (`IBAN`);
